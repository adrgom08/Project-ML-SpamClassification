...
# Using MLP (ANN) for classification of emails
...
mlp_classifier = MLPClassifier(learning_rate='adaptive', activation='logistic') #Optimal parameters
mlp_classifier.fit(X_train_transformed, y_train)

# Make predictions on the testing set
y_pred = mlp_classifier.predict(X_test_transformed)
