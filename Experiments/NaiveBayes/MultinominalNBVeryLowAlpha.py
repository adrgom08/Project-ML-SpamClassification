...
# Using the Multinomial Bayes algorithm with alpha = 0.000001 for classification of emails
...
nb_classifier = MultinomialNB(alpha = 0.000001) #set a very low alpha 
...
print("Accuracy of Multinomial Naive Bayes (alpha = 0.000001): ", accuracy)