...
# Using the Multinomial Bayes algorithm with alpha = 0.5for classification of emails
...
nb_classifier = MultinomialNB(alpha = 0.5) #set a lower alpha 
...
print("Accuracy of Multinomial Naive Bayes(0.5): ", accuracy)